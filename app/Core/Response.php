...
class Response
{
  ...
  // Method to respond with a generic text
  ...
  // Method to respond with a redirect
  ...
  // Method to respond with a CSV file
  ...
  // Method to respond with a PDF file
  public static function pdf(string $filePath): void
  {
    if (file_exists($filePath)) {
